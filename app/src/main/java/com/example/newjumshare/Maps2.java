        ...
        btnarrive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setTitle("Ending the session")
                        .setMessage("Do you End the ride session?")
                        .setCancelable(true)
                        .setPositiveButton("End", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {

                                Intent intent = new Intent(Maps2.this, HomeScreen.class);
...
//                                });
                        ...
                        .setNegativeButton("Don't End", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
        ...
        if (num_pass == 1) {
            ...
            try {
                ...
                if (listAddress.size() > 0) {
                    ...
                    Toast.makeText(Maps2.this,"Dont", Toast.LENGTH_SHORT).show();
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
                ...
                try {
                    ...
                    if (status.equals("OK")) {
                        ...
                        for (int i = 0; i < routes.length(); i++) {
                            ...
                            polylineOptions.color(ContextCompat.getColor(Maps2.this, R.color.purple_500));
    ...
    private void checkmyPermission() {
        Dexter.withContext(this).withPermission(Manifest.permission.ACCESS_FINE_LOCATION).withListener(new PermissionListener() {
            ...
            public void onPermissionGranted(PermissionGrantedResponse permissionGrantedResponse) {
                Toast.makeText(Maps2.this, "Permission Granted", Toast.LENGTH_SHORT).show();
            }
