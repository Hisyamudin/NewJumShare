...
public class Maps3 extends AppCompatActivity implements OnMapReadyCallback,
    ...
    String keydrivers, driverkeyid, ids, uid, driverkey, item1, Location, destination1, destination2, destination3, destination4, destination5, destination6, url;
    int num_pass;
    ...
    double latz;
    DatabaseReference ongoingref, ridestartref , userref, driverref, delref2, driversdataref, userref2;
    Query delref;
    ...
    private long UPDATE_INTERVAL = 150000;
    ...
    //DatabaseReference requestreference, dateref,userdata,reference,delref,reference2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        driversdataref = FirebaseDatabase.getInstance().getReference("drivers_data");
...
//                                driverref.orderByChild("driver_id").equalTo(FirebaseAuth.getInstance().getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
//                                    @Override
...
//                                                String empty = "";
//                                                delref = FirebaseDatabase.getInstance().getReference().child("booked_drivers").child(event.getBooked_data_key());
//
//                                            }
//                                        } else {
...
//                                driversdataref.orderByChild("id").equalTo(FirebaseAuth.getInstance().getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
//                                    @Override
//                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
//                                        if (snapshot.exists()) {
//                                            for (DataSnapshot snapshots : snapshot.getChildren()) {
...
//
//                                                delref2 = FirebaseDatabase.getInstance().getReference().child("drivers_data").child(driverkeyid);
//
//                                            }
//                                        } else {
//                                            //Toast.makeText(HomeScreen.this, "", Toast.LENGTH_SHORT).show();
...
//                                });
                                ...
                                //delref = FirebaseDatabase.getInstance().getReference().child("booked_drivers").child(driverkeyid);
                                delref = FirebaseDatabase.getInstance().getReference("booked_drivers").orderByChild("key_driver").equalTo(driverkeyid);
                                ...
                                delref2 = FirebaseDatabase.getInstance().getReference("drivers_data");
                                delref2.child(driverkeyid).removeValue();
                                Intent intenty = new Intent(Maps3.this, HomeScreen.class);
...
//.appendQueryParameter("waypoints", "-6.9249233,107.6345122")
    ...
    private void direction(int num_pass, String latstart, String lngstart) {
        ...
        if (num_pass == 1) {
            ...
            Geocoder geocoder = new Geocoder(Maps3.this, Locale.getDefault());
            try {
                ...
                try {
                    ...
                    if (status.equals("OK")) {
                        ...
                        for (int i = 0; i < routes.length(); i++) {
                            ...
                            polylineOptions.color(ContextCompat.getColor(Maps3.this, R.color.purple_500));
    ...
    private void checkmyPermission() {
        Dexter.withContext(this).withPermission(Manifest.permission.ACCESS_FINE_LOCATION).withListener(new PermissionListener() {
            @Override
            public void onPermissionGranted(PermissionGrantedResponse permissionGrantedResponse) {
                Toast.makeText(Maps3.this, "Permission Granted", Toast.LENGTH_SHORT).show();
            }
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            for (DataSnapshot snapshots : snapshot.getChildren()) {
                                ...
                                //Toast.makeText(Maps3.this,"test",Toast.LENGTH_SHORT).show();
