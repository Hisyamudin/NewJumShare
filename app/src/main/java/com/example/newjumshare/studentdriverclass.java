...
public class studentdriverclass {
    String fullNames, car, plate_number, CarColor, phoneNum, time, event_name, gender,pic,id,capacity,car_id,driver_id,date_data,destination;
    ...
    public studentdriverclass(String fullNames, String car, String plate_number, String carColor, String phoneNum, String time, String event_name, String gender, String pic,String id,String capacity,String car_id,String driver_id, String date_data, String destination) {
